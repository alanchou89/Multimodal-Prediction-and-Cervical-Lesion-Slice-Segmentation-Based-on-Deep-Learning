...
class fusion_model_mae_2(nn.Module):
    def __init__(self, in_feats, n_hidden, out_classes, dropout=0.3, train_type_num=3):  # dropout=0.3
...
#         TransformerConv
        ...
        self.lin1_imgA = torch.nn.Linear(out_classes,out_classes//4)             # 512 128
        self.lin2_imgA = torch.nn.Linear(out_classes//4,out_classes//4//4)       # 128 32  
        self.lin3_imgA = torch.nn.Linear(out_classes//4//4,out_classes//4//4//4) # 32  8

        self.lin1_imgL = torch.nn.Linear(out_classes,out_classes//4)             # 512 128
        self.lin2_imgL = torch.nn.Linear(out_classes//4,out_classes//4//4)       # 128 32 
        self.lin3_imgL = torch.nn.Linear(out_classes//4//4,out_classes//4//4//4) # 32  8

        self.lin1_cli = torch.nn.Linear(out_classes,out_classes//4)              # 512 128
        self.lin2_cli = torch.nn.Linear(out_classes//4,out_classes//4//4)        # 128 32 
        ...
        # 新增一個全連接層用於類別預測
        self.classifier = nn.Linear(out_classes//4//4//4, 4)       # 8->4 , 假設有 4 種病灶類型
        # 新增模態特定的分類器
        self.classifier_imgN = nn.Linear(out_classes//4//4//4, 4)  # 8->4 , 假設有 4 種病灶類型
        self.classifier_imgA = nn.Linear(out_classes//4//4//4, 4)  # 8->4 , 假設有 4 種病灶類型
        self.classifier_imgL = nn.Linear(out_classes//4//4//4, 4)  # 8->4 , 假設有 4 種病灶類型
        self.classifier_cli  = nn.Linear(out_classes//4//4//4, 4)  # 8->4 , 假設有 4 種病灶類型
