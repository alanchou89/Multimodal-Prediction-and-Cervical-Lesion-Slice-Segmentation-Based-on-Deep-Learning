    ...
    for seed in range(start_seed, start_seed + repeat_num):
        ...
        for train_index, test_index in kf.split(patient_ids,kf_label):
            ...
            for epoch in range(epochs):
                ...
                print("epoch:{:2d}, train_accuracy_imgN:{:.4f}, train_accuracy_imgA:{:.4f}, train_accuracy_imgL:{:.4f}".format(epoch,train_accuracy_imgN,train_accuracy_imgA,train_accuracy_imgL)) 
